        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-9">
            <div className="flex flex-col">
              ...
              <input type="text" id="address" placeholder="Enter your address" required value={address}
              ...
              <input type="text" id="pinCode"  placeholder="Enter your pin code" required value={pinCode}
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center mb-2">
                  <input type="radio" id="cashOnDelivery" name="paymentMethod"
                    className="mr-2" value="Cash On Delivery" required/>
                ...
                <div className="flex items-center mb-2">
                  <input type="radio" id="upi" name="paymentMethod"
                    className="mr-2"value="UPI" required
                  />
                  <label htmlFor="upi" className="text-sm text-gray-700">UPI</label>
                </div>
                <div className="flex items-center mb-2">
                  <input type="radio" id="netBanking" name="paymentMethod" className="mr-2"value="Net Banking" required/>
